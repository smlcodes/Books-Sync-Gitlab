    ...
    <div class="dashboard-main-wrapper">
	    ...
	    <div class="dashboard-header">
	        <nav class="navbar navbar-expand-lg bg-white fixed-top">
	            <a class="navbar-brand" href="index.jsp">Concept</a>
	            ...
	            <div class="collapse navbar-collapse " id="navbarSupportedContent">
	                <ul class="navbar-nav ml-auto navbar-right-top">
	                    ...
	                    <li class="nav-item dropdown connection">
	                        <a class="nav-link" href="pages/#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-fw fa-th"></i> </a>
	            ...
	            <nav class="navbar navbar-expand-lg navbar-light">
	                ...
	                <div class="collapse navbar-collapse" id="navbarNav">
	                    <ul class="navbar-nav flex-column">
	                        ...
	                        <li class="nav-item ">
	                            ...
	                            <div id="submenu-1" class="collapse submenu" style="">
	                                <ul class="nav flex-column">
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-2" aria-controls="submenu-1-2">E-Commerce</a>
	                                        <div id="submenu-1-2" class="collapse submenu" style="">
	                                            <ul class="nav flex-column">
	                                                <li class="nav-item">
	                                                    <a class="nav-link" href="pages/index.jsp">E Commerce Dashboard</a>
	                                                </li>
	                                                <li class="nav-item">
	                                                    <a class="nav-link" href="pages/ecommerce-product.jsp">Product List</a>
	                                                </li>
	                                                <li class="nav-item">
	                                                    <a class="nav-link" href="pages/ecommerce-product-single.jsp">Product Single</a>
	                                                </li>
	                                                <li class="nav-item">
	                                                    <a class="nav-link" href="pages/ecommerce-product-checkout.jsp">Product Checkout</a>
	                                                </li>
	                                            </ul>
	                                        </div>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/dashboard-finance.jsp">Finance</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/dashboard-sales.jsp">Sales</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-1" aria-controls="submenu-1-1">Infulencer</a>
	                                        <div id="submenu-1-1" class="collapse submenu" style="">
	                                            <ul class="nav flex-column">
	                                                <li class="nav-item">
	                                                    <a class="nav-link" href="pages/dashboard-influencer.jsp">Influencer</a>
	                                                </li>
	                                                <li class="nav-item">
	                                                    <a class="nav-link" href="pages/influencer-finder.jsp">Influencer Finder</a>
	                                                </li>
	                                                <li class="nav-item">
	                                                    <a class="nav-link" href="pages/influencer-profile.jsp">Influencer Profile</a>
	                                                </li>
	                                            </ul>
	                                        </div>
	                                    </li>
	                        ...
	                        <li class="nav-item">
	                            <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i>UI Elements</a>
	                            <div id="submenu-2" class="collapse submenu" style="">
	                                <ul class="nav flex-column">
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/cards.jsp">Cards <span class="badge badge-secondary">New</span></a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/general.jsp">General</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/carousel.jsp">Carousel</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/listgroup.jsp">List Group</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/typography.jsp">Typography</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/accordions.jsp">Accordions</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/tabs.jsp">Tabs</a>
	                                    </li>
	                                </ul>
	                            </div>
	                        </li>
	                        <li class="nav-item">
	                            <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-fw fa-chart-pie"></i>Chart</a>
	                            <div id="submenu-3" class="collapse submenu" style="">
	                                <ul class="nav flex-column">
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/chart-c3.jsp">C3 Charts</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/chart-chartist.jsp">Chartist Charts</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/chart-charts.jsp">Chart</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/chart-morris.jsp">Morris</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/chart-sparkline.jsp">Sparkline</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/chart-gauge.jsp">Guage</a>
	                                    </li>
	                                </ul>
	                            </div>
	                        </li>
	                        <li class="nav-item ">
	                            <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i>Forms</a>
	                            <div id="submenu-4" class="collapse submenu" style="">
	                                <ul class="nav flex-column">
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/form-elements.jsp">Form Elements</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/form-validation.jsp">Parsely Validations</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/multiselect.jsp">Multiselect</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/datepicker.jsp">Date Picker</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/bootstrap-select.jsp">Bootstrap Select</a>
	                                    </li>
	                                </ul>
	                            </div>
	                        </li>
	                        <li class="nav-item">
	                            <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Tables</a>
	                        ...
	                        <li class="nav-item">
	                            <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-6" aria-controls="submenu-6"><i class="fas fa-fw fa-file"></i> Pages </a>
	                            <div id="submenu-6" class="collapse submenu" style="">
	                                <ul class="nav flex-column">
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/blank-page.jsp">Blank Page</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/blank-page-header.jsp">Blank Page Header</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/login.jsp">Login</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/404-page.jsp">404 page</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/sign-up.jsp">Sign up Page</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/forgot-password.jsp">Forgot Password</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/pricing.jsp">Pricing Tables</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/timeline.jsp">Timeline</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/calendar.jsp">Calendar</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/sortable-nestable-lists.jsp">Sortable/Nestable List</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/widgets.jsp">Widgets</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/media-object.jsp">Media Objects</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/cropper-image.jsp">Cropper</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/color-picker.jsp">Color Picker</a>
	                                    </li>
	                                </ul>
	                            </div>
	                        </li>
	                        <li class="nav-item">
	                            <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7"><i class="fas fa-fw fa-inbox"></i>Apps <span class="badge badge-secondary">New</span></a>
	                            <div id="submenu-7" class="collapse submenu" style="">
	                                <ul class="nav flex-column">
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/inbox.jsp">Inbox</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/email-details.jsp">Email Detail</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/email-compose.jsp">Email Compose</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/message-chat.jsp">Message Chat</a>
	                                    </li>
	                                </ul>
	                            </div>
	                        </li>
	                        <li class="nav-item">
	                            <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-8" aria-controls="submenu-8"><i class="fas fa-fw fa-columns"></i>Icons</a>
	                            <div id="submenu-8" class="collapse submenu" style="">
	                                <ul class="nav flex-column">
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/icon-fontawesome.jsp">FontAwesome Icons</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/icon-material.jsp">Material Icons</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/icon-simple-lineicon.jsp">Simpleline Icon</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/icon-themify.jsp">Themify Icon</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/icon-flag.jsp">Flag Icons</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/icon-weather.jsp">Weather Icon</a>
	                                    </li>
	                                </ul>
	                            </div>
	                        </li>
	                        <li class="nav-item">
	                            <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-9" aria-controls="submenu-9"><i class="fas fa-fw fa-map-marker-alt"></i>Maps</a>
	                            <div id="submenu-9" class="collapse submenu" style="">
	                                <ul class="nav flex-column">
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/map-google.jsp">Google Maps</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/map-vector.jsp">Vector Maps</a>
	                                    </li>
	                                </ul>
	                            </div>
	                        </li>
	                        <li class="nav-item">
	                            <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-f fa-folder"></i>Menu Level</a>
	                            <div id="submenu-10" class="collapse submenu" style="">
	                                <ul class="nav flex-column">
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/#">Level 1</a>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-11" aria-controls="submenu-11">Level 2</a>
	                                        <div id="submenu-11" class="collapse submenu" style="">
	                                            <ul class="nav flex-column">
	                                                ...
	                                                <li class="nav-item">
	                                                    <a class="nav-link" href="pages/#">Level 2</a>
	                                                </li>
	                                            </ul>
	                                        </div>
	                                    </li>
	                                    <li class="nav-item">
	                                        <a class="nav-link" href="pages/#">Level 3</a>
	                                    </li>
	                                </ul>
	                            </div>
	                        </li>
	        ...
	        <div class="dashboard-influence">
	            <div class="container-fluid dashboard-content">
	                ...
	                <div class="row">
	                                ...
	                                <div class="container-fluid">
	                                    <div class="row">
	                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
	                                           Copyright © 2021 Satya Kaveti. All rights reserved.
	                                        </div>
	                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
	                    ...
	                    <script src="../assets/vendor/charts/morris-bundle/morrisjs.jsp"></script>
	                    <!-- chart js -->
